...
public class AccountOperationsTest {
    ...
    @Before
    public void setUp() {
        savingsAccount = new SavingsAccount(1, "SAV001", AccountType.SAVINGS, new BigDecimal("1000.00"));
        checkingAccount = new CheckingAccount(1, "CHK001", AccountType.CHECKING, new BigDecimal("500.00"));
    }
